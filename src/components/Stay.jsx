    ...
    return (
        <article>
            ...
            <div className="flex items-center justify-start h-7 mb-3">
                {
                    superHost && <span className="inline-block mr-3 uppercase font-bold text-[0.625rem] md:text-[0.75rem] text-zinc-600 border border-zinc-600 px-2 py-1 rounded-[100px]">Super host</span>
                }
